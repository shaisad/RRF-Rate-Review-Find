...
<link href="/css/bootstrap.min.css" rel="stylesheet">
    ...
    <title>RRF Restaurant Menu</title>
</head>
...
<div class="cardfix">
   <div class="container py-5">
    <div class="row mt-3">
      ...
      $query = "SELECT * FROM food_new where frestaurantname = '$_POST[live_search]'";
      ...
      if($check_user)
      {
        while($row = mysqli_fetch_assoc($query_run))
        {
          ...
          // Include the database configuration file  
           ...
           $queryy = "SELECT image from foodimage where foodname = '$row[foodname]' and irestaurantname = '$_POST[live_search]' ";
