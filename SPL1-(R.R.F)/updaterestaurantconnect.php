...
if (isset($_POST['submitname']))
{
    ...
    if ($db->query($query) === TRUE && $db->query($query2) === TRUE && $db->query($query3) === TRUE) {
        echo "Record updated successfully. Click <a href='http://localhost/SPL1--R.R.F-1/SPL1-(R.R.F)/RestaurantSignInPage.html'> here to login </a> to ensure your details are
                 updated.";
       } else {
...
if (isset($_POST['submitemail']))
{
  ...
  function sendMail($restaurantemail,$code)
  {
    ...
    $mail->Body = "Dear restaurant, Click the link to verify your recently changed email
                   <a href='http://localhost/SPL1--R.R.F-1/SPL1-(R.R.F)/restaurantupdateverify.php?restaurantemail=$restaurantemail&code=$code'> Verify </a>";
