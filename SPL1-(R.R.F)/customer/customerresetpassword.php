...
<html>
	<head>
		<meta charset="utf-8">
		<title>RRF User Reset Password</title>
    ...
    <body>
		<div class="UserSignUp">
			<h1><div class="logo">
				...
				<img class="rrflogo" src="image/logonavbarwithoutbg.png" alt="logo">
		
			</div>Reset Password</h1>
			<form action="customer/customerresetpasswordcode.php" method="post" autocomplete="on">
