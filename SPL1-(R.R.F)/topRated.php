...
<body>
   ...
   <div class="container py-5">
    <div class="row mt-3">
      ...
      $query = "SELECT restaurantname, location, reviewrid, restaurantid, avg(rating) as overall_rating FROM (select restaurantname, location, reviewrid, restaurantid, avg(rating) as overall_rating from restaurant, res_reviews where 
      res_reviews.reviewrid = restaurant.restaurantid and restaurant.status=1 group by restaurantname order by overall_rating desc) where ROWNUM=2 ";
